...
# HEAR eksempler
#
# Version 0.2 Knud - SHD - 04 dec. 2020 - Simplifisering ud fra første udgave. Kun brug for at plotte en curve. Bruger venstre kanal.
#
...
#
    def __init__(self,signal,time_to_plot=10,amp_max=20000):
        ...
        self.left_plot = plt.subplot(111)  # husk plot så kurven kan genfindes - bruges i clear curves og update
    ...
    def add_title(self,text=" "):   # Only to be used when signal is 'pure' that is with only one freq.
        plt.title(text)                
        # For at få tegnet plot færdigt inden der sker andet i koden skal der ventes lidt 
        #     
        plt.pause(0.01)
